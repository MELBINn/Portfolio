...
const ContactForm = () => {
    ...
    const validate = () =>{
        ...
        if(!formData.message) errors.message = "Messege is required";
        return errors;
        }
                ...
                setErrors(validationErrors);
                   ...
                   emails 
                          ...
                          .catch((error)=>{
                            ...
                            toast.error("Failed to send messsege.please try again later");
                          })
                          .finally(()=>{
                            setIsSending(false);
                          })
    ...
    <div className='p-4 lg:w-3/4' id="contact">
      ...
      onSubmit={handleSubmit}>
        ...
        <div className='mb-4'>
          ...
          text-semibold text-stone-900 hover:bg-stone-300
